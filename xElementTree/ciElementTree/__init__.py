...
__all__ = ['ElementTree', 'Element', 'SubElement', 'ParseError', 'TreeBuilder', 'XMLParser', 'XMLParserError', 'XMLTreeBuilder', 'VERSION', '__version__']
...
try:
    # Fallback to regular (unpatched) modules
    from xml.etree.cElementTree import *  # NOQA
except ImportError:
    from xml.etree.ElementTree import *  # NOQA

try:
    # Try importing the C accelerators
    from ._ciElementTree import Element, SubElement, ParseError, TreeBuilder, XMLParser  # NOQA
    ...
    def tostring(element, encoding=None, method=None):
        stream = StringIO() if encoding == 'unicode' else BytesIO()
    ...
    def tostringlist(element, encoding=None, method=None):
        try:
            ...
            raise NotImplementedError("tostringlist() is not available")
        lst = []
